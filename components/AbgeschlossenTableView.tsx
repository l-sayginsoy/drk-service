...
interface AbgeschlossenTableViewProps {
  tickets: Ticket[];
...
const AbgeschlossenTableView: React.FC<AbgeschlossenTableViewProps> = ({ tickets, onSelectTicket }) => {
    ...
    return (
        <div className="table-view-container">
            <style>{`
                /* Using shared styles with TicketTableView, specific overrides can be added here if needed */
                ...
                .priority-pill.priority-low { background-color: rgba(40, 167, 69, 0.1); color: #218838; border-color: rgba(40, 167, 69, 0.3); }
            `}</style>
...
export default AbgeschlossenTableView;